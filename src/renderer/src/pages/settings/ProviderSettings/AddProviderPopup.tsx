          ...
          onChange={async ({ file }) => {
            try {
              ...
              if (provider?.id) {
                ...
                const savedLogo = await ImageStorage.get(
                  `provider-${provider.id}`,
                );
                setLogo(savedLogo);
              } else {
  ...
  return (
    ...
    >
      ...
      <Form layout="vertical" style={{ gap: 8 }}>
        <Form.Item
          label={t("settings.provider.add.name.label")}
        ...
        <Form.Item
          label={t("settings.provider.add.type")}
        ...
        >
          <Select
            ...
            onChange={(value: string) => {
              ...
              setType(
                value === "cherryin-type" ? "new-api" : (value as ProviderType),
              );
            }}
            options={[
